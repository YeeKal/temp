...
int main(int argc,char **argv){
	...
	moveit_msgs::Constraints pose_goal=kinematic_constraints::constructGoalConstraints(end_effector_name,pose,tolerance_pose,tolerance_angle);

    //path constraints
    moveit_msgs::OrientationConstraint ocm;
    ocm.link_name = end_effector_name;
	...
	req.path_constraints=test_constraints;
    ...
    //publish axis
    int state_count=display_trajectory.trajectory[0].joint_trajectory.points.size();
    int joint_count=display_trajectory.trajectory[0].joint_trajectory.joint_names.size();
    for(int i=0;i<state_count;i++){
        std::vector<double> joint_values_path=display_trajectory.trajectory[0].joint_trajectory.points[i].positions;
